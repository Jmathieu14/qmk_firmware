...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LGUI, MO(3), KC_LALT, KC_SPC, KC_LSFT, LT(4,KC_ENT), MO(5), KC_TRNS, MO(6), RALT(KC_LEFT), RALT(KC_RGHT)),

    [1] = LAYOUT_planck_mit( \
    KC_Q, KC_W, KC_E, KC_R, KC_1, KC_4, KC_7, KC_T, KC_HOME, KC_I, KC_PGUP, KC_F12, \
    KC_A, KC_S, KC_D, KC_F, KC_2, KC_5, KC_8, KC_G, KC_END, KC_UP, KC_PGDN, ANY(LSFT(LCTL(KC_TAB))), \
    KC_Z, KC_X, KC_C, KC_SPC, KC_3, KC_6, KC_9, KC_B, KC_LEFT, KC_DOWN, KC_RGHT, ANY(LSFT(LCTL(KC_GRV))), \
