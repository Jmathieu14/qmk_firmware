...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[DEFAULT] = LAYOUT( \
		LT(NUM,KC_ESC)  , KC_Q          , KC_W          , KC_F          , KC_P          , KC_G          , KC_J                , KC_L          , KC_U          , KC_Y          , KC_SCLN       , KC_DEL         , KC_BSPC, \
		LT(MEDIA,KC_TAB), KC_A          , KC_S          , KC_R          , KC_T          , KC_D          , KC_H                , KC_N          , KC_E          , KC_I          , KC_O          , TD(NTR_BCKSLSH), \
		KC_LCTL         , KC_Z          , KC_X          , KC_C          , KC_V          , KC_B          , LT(SYM_FUNC,KC_QUOT), KC_K          , KC_M          , KC_COMM       , KC_DOT        , KC_SLSH        , MO(NUM), \
