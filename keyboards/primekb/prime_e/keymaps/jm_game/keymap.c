...
qk_tap_dance_action_t tap_dance_actions[] = {
    [LALT_NUM] = ACTION_TAP_DANCE_DOUBLE(KC_LALT, MO(NUM)),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LT(SYM_FUNC,KC_TAB), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, TD(NTR_BCKSLSH), \
    KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, LT(GAME,KC_QUOT), KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(NUM), \
    KC_LSFT, KC_LGUI, TD(LALT_NUM), LSFT_T(KC_SPC), KC_SPC, MO(NAV), KC_RALT, KC_RCTL),
    ...
    KC_LCTL, KC_TRNS, KC_TRNS, KC_TRNS, TD(V_THREE), TD(B_SIX), TD(N_NINE), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
    ...
    KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_UNDS, KC_TRNS, KC_EQL, KC_NO, KC_LCBR, KC_RCBR, KC_QUES, KC_NO, \
