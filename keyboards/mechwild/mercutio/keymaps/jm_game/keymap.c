...
qk_tap_dance_action_t tap_dance_actions[] = {
    [Z_QUOTE] = ACTION_TAP_DANCE_DOUBLE(KC_Z, KC_QUOTE),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[DEFAULT] = LAYOUT_all( \
                                                                                                                                            KC_MUTE        , \
		LT(NUM,KC_ESC)  , KC_Q   , KC_W   , KC_F          , KC_P        , KC_B           , KC_J       , KC_L   , KC_U   , KC_Y   , KC_SCLN, TD(BSPC_DEL)   , \
		LT(MEDIA,KC_TAB), KC_A   , KC_S   , KC_R          , KC_T        , KC_G           , KC_M       , KC_N   , KC_E   , KC_I   , KC_O   , KC_ENT         , \
		KC_LCTL         , KC_LSFT, KC_X   , KC_C          , KC_D        , KC_V           , TD(Z_QUOTE), KC_K   , KC_H   , KC_COMM, KC_DOT , LT(NUM,KC_SLSH), \
    ...
    [GAME] = LAYOUT_all( \
		...
		KC_LCTL         , KC_LCTL, KC_Z   , KC_X          , KC_C        , KC_V           , KC_B       , KC_N   , KC_M   , KC_COMM, KC_DOT , LT(NUM,KC_SLSH), \
		KC_ESC          , KC_LGUI, KC_LALT, KC_LSFT       , MO(SYM_FUNC), LT(NAV,KC_SPC) , KC_RALT, KC_F4  , TO(DEFAULT)),

	[NAV] = LAYOUT_all( \
		                                                                                                               KC_TRNS, \
		KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO   , KC_NO  , KC_PGUP, KC_HOME, KC_UP        , KC_END       , KC_PGDN, \
		KC_NO  , KC_NO  , KC_NO  , KC_NO  , KC_NO  , TO(GAME), KC_NO  , KC_NO  , KC_LEFT, KC_DOWN      , KC_RGHT      , KC_ENT , \
