...
def main():
    ...
    mercutio_switch_layout = KeyboardSwitchLayout([switch_row1, switch_row2, switch_row3, switch_row4])
    mercutio_keymap_filepath = '../keyboards/mechwild/mercutio/keymaps/jm_game/keymap.c'
    my_layout = parse_keymap_c(mercutio_keymap_filepath, mercutio_switch_layout)
