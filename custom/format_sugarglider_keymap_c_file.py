...
def main():
    ...
    switch_row2 = KeyboardSwitchRow(14)
    switch_row3 = KeyboardSwitchRow(13)
    switch_row4 = KeyboardSwitchRow(11)
    prime_e_switch_layout = KeyboardSwitchLayout([switch_row1, switch_row2, switch_row3, switch_row4])
    prime_e_keymap_filepath = './keyboards/mechwild/sugarglider/keymaps/Jacques Mathieu/keymap.c'
